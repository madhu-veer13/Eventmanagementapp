      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent">
            EventExpress Dashboard
          </h1>
          <p className="text-lg text-gray-600">
            Manage your bookings and track your event planning journey with EventExpress
          </p>
        </div>
            ...
            {bookings.length === 0 ? (
              <div className="text-center py-10">
                ...
                <p className="text-gray-500 mb-4">
                  Start by booking your first event service with EventExpress!
                </p>
                <Button onClick={() => onNavigate("services")}>
                  Browse Services
                </Button>
